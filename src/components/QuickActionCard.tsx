...
const QuickActionCard: React.FC<QuickActionCardProps> = ({ title, description, icon: Icon, to, colorClass }) => {
  return (
    <Link
      to={to}
      className="block bg-card-light dark:bg-card-dark p-6 rounded-xl shadow-subtle dark:shadow-md-dark transition-transform duration-200 hover:scale-[1.02] hover:shadow-lg dark:hover:shadow-xl-dark group"
    >

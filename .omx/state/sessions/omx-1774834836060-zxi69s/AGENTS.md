...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1774834836060-zxi69s | 2026-03-30T01:40:36.565Z

**Codebase Map:**
  src/: App, main, vite-env.d
  src/components/: DashboardCard, EditAssetModal, EditTicketModal, Header, Layout, MainLayout, Navbar, Sidebar, TopBar, TopNav
  src/constants/: enums, roles
  src/context/: AuthContext, TicketDrawerContext
  src/features/: assignAsset, changeStatus, createAsset, getAssetLogs, updateAsset, AssetAssignmentSection, AssetDrawer, AssetDynamicSection, AssetHistory, AssetHistoryItem
  src/hooks/: use-toast, useAdminUsers, useAssetCategories, useAssetFieldValues, useAssetFields, useAssetRequests, useAssetTypes, useAssets, useAssignableUsers, useAuth
  src/lib/: export, motion, notify, permissions, sla, supabase, theme, ticket-ui, utils
  src/pages/: AssetManagement, AssetRequests, Assets, AssetsWorkspace, Dashboard, Notifications, Profile, Register, Reports, SettingsAndLogs
  src/services/: assetLogs
  src/test/: setup
  src/types/: asset-log, asset, database.types, supabase
  src/utils/: diffAsset
  scripts/: seedProfiles
  dist/: AssetManagement-D6PaNTkK, As...

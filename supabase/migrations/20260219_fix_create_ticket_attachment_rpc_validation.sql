/*
  # Fix create_ticket_attachment RPC validation edge cases

  - Handle non-integer attachment_max_size_mb safely
  - Allow image wildcard by file extension when MIME type is missing
*/

/*
  # Persist attachment rejection logs

  PostgreSQL rolls back all writes when an exception is raised.
  To keep rejection logs in public.logs, this function now:
  - writes a rejection log

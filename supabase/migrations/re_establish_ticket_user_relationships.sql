/*
  # Re-establish Ticket-User Relationships and RLS
  ...
  2. Security:
    ...
    - Recreate RLS policies for `tickets` to allow authenticated users to read all tickets.
    - Recreate RLS policies for `users` to allow authenticated users to read all user data (needed for displaying assigned_to and created_by names).
*/

/*
  # Add foreign key constraint to profiles.role (V3)
...
BEGIN
  ...
  IF EXISTS (
    ...
    -- Check if the 'role' column exists in 'profiles'
    IF EXISTS (
      SELECT 1
      ...
      END IF;
    ELSE
      RAISE WARNING 'Column "role" does not exist in table "profiles". Skipping foreign key creation.';
    END IF;
  ELSE

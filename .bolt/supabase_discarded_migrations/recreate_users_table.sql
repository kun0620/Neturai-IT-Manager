/*
      # Recreate users table and add RLS policies (Fixed Syntax)
      ...
      4. Important Notes
        - Removed `IF NOT EXISTS` from `CREATE POLICY` statements to fix syntax error.
    */
    ...
    -- Initial RLS policies (will be refined in the next migration)
    -- Policy for Admins: Can do anything
    -- Removed IF NOT EXISTS as it's not supported for CREATE POLICY
